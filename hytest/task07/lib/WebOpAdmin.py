...
class WebOpAdmin():
    ...
    def AddTeacher(self,teacherName,teacherUserName,teacherDesc,teacherIndex,teachCourseList):
        # 点击老师
        self.driver.find_element_by_css_selector(
            "a[ui-sref=\"teacher\"]").click()
        sleep(1)
        self.driver.find_element_by_css_selector(
            "button[ng-click=\"showAddOne=true\"]").click()
        self.driver.find_element_by_css_selector(
            "input[ng-model=\"addEditData.realname\"]").clear()
        self.driver.find_element_by_css_selector(
            "input[ng-model=\"addEditData.realname\"]").send_keys(teacherName)
        self.driver.find_element_by_css_selector(
            "input[ng-model=\"addEditData.username\"]").clear()
        self.driver.find_element_by_css_selector(
            "input[ng-model=\"addEditData.username\"]").send_keys(teacherUserName)
        self.driver.find_element_by_css_selector(
            "textarea[ng-model=\"addEditData.desc\"]").clear()
        self.driver.find_element_by_css_selector(
            "textarea[ng-model=\"addEditData.desc\"]").send_keys(teacherDesc)
        self.driver.find_element_by_css_selector(
            "input[ng-model=\"addEditData.display_idx\"]").clear()
        self.driver.find_element_by_css_selector(
            "input[ng-model=\"addEditData.display_idx\"]").send_keys(teacherIndex)
        self.driver.implicitly_wait(1)
        # 将之前一次添加的授课信息清除
        while True:
            eles = self.driver.find_elements_by_css_selector(
        ...
        for teachCourse in teachCourseList:
            self.driver.find_element_by_css_selector(
                f"option[label=\"{teachCourse}\"]").click()
            self.driver.find_element_by_css_selector(
                ".fa-plus").click()
        self.driver.find_element_by_css_selector(
            "button[ng-click=\"addOne()\"]").click()
    ...
    def DeleteAllClasses(self):
        # 点击培训班
        self.driver.find_element_by_css_selector(
            "a[ui-sref=\"training\"]").click()
        sleep(1)
        self.driver.implicitly_wait(1)
        while True:
            eles = self.driver.find_elements_by_css_selector(
                "tr td:nth-child(5) button[ng-click=\"delOne(one)\"]")
            if eles == []:
                break
            eles[0].click()
            self.driver.find_element_by_css_selector(
    ...
    def AddClass(self,className,classDesc,classIndex,containCourses):
        ...
        self.driver.find_element_by_css_selector(
            "button[ng-click=\"showAddOne=true\"]").click()
        self.driver.find_element_by_css_selector(
            "input[ng-model=\"addEditData.name\"]").clear()
        self.driver.find_element_by_css_selector(
            "input[ng-model=\"addEditData.name\"]").send_keys(className)
        self.driver.find_element_by_css_selector(
            "textarea[ng-model=\"addEditData.desc\"]").clear()
        self.driver.find_element_by_css_selector(
            "textarea[ng-model=\"addEditData.desc\"]").send_keys(classDesc)
        self.driver.find_element_by_css_selector(
            "input[ng-model=\"addEditData.display_idx\"]").clear()
        self.driver.find_element_by_css_selector(
            "input[ng-model=\"addEditData.display_idx\"]").send_keys(classIndex)
        self.driver.implicitly_wait(1)
        while True:
            eles = self.driver.find_elements_by_css_selector(
                "button[ng-click=\"addEditData.delTeachCourse(course)\"]")
    ...
    def AddClassData(self,classDatas,classDataDesc,classDataIndex,belongClass):
        ...
        self.driver.find_element_by_css_selector(
            "input[ng-model=\"addEditData.name\"]").clear()
        self.driver.find_element_by_css_selector(
            "input[ng-model=\"addEditData.name\"]").send_keys(classDatas)
        self.driver.find_element_by_css_selector(
            "textarea[ng-model=\"addEditData.desc\"]").clear()
        self.driver.find_element_by_css_selector(
            "textarea[ng-model=\"addEditData.desc\"]").send_keys(classDataDesc)
        self.driver.find_element_by_css_selector(
            "input[ng-model=\"addEditData.display_idx\"]").clear()
        self.driver.find_element_by_css_selector(
            "input[ng-model=\"addEditData.display_idx\"]").send_keys(classDataIndex)
        self.driver.find_element_by_tag_name(
            "select").click()
        self.driver.find_element_by_css_selector(
            f"option[label=\"{belongClass}\"]").click()
        self.driver.find_element_by_css_selector(
            "button[ng-click=\"addOne()\"]").click()
